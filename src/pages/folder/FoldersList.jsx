        ...
        >
          <div className="flex flex-col items-center justify-center w-full h-64 rounded-3xl p-2">
            <div className="relative w-24 sm:w-32 h-24 sm:h-32 bg-white rounded-2xl shadow-md flex items-center justify-center group overflow-hidden cursor-pointer">
              ...
              <svg
                className="w-12 sm:w-16 h-12 sm:h-16 text-gray-400 relative z-10 transition-transform duration-300 ease-in-out group-hover:scale-95"
                fill="none"
                strokeLinecap="round"
            ...
            <p className="mt-4 sm:mt-6 text-base sm:text-lg font-semibold text-gray-700 cursor-pointer">{folder.name}</p>
          </div>
        </Link>
      )) : <></>}
    </div>
